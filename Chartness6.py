...
if chart_type == "Short Term":
    ...
    fig.add_hline(y=20, row=2, col=1, line_width=0.8, line_color="green")
    fig.add_hline(y=50, row=2, col=1, line_width=0.8, line_color="black")
    fig.add_hline(y=80, row=2, col=1, line_width=0.8, line_color="red")
    ...
    fig.add_hline(y=20, row=3, col=1, line_width=0.8, line_color="green")
    fig.add_hline(y=50, row=3, col=1, line_width=0.8, line_color="black")
    fig.add_hline(y=80, row=3, col=1, line_width=0.8, line_color="red")
    st.plotly_chart(fig, use_container_width=True)